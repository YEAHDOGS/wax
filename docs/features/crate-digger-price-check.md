...
Status: spec (2026-09-09). Origin: user standing in a record store asking
...
holding the record, not for a user database. (user, 2026-09-09:
...
1. Release resolution from barcode/catalog# (Discogs search).
   - **BUILT (2026-09-09, jack/wax-checkout-v1):** the scan pipeline —
     ...
     service layer is still pending — user's call on wiring keys there.
